...
# Random 47 bytes for session key.
...
def register():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form:
        ...
        # If account exists show error. Otherwise perform validation checks.
        if account:
            msg = 'Account already exists! Please try a new username'
